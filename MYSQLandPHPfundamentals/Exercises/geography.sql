...
-- Dumping database structure for geography
CREATE DATABASE IF NOT EXISTS `geography` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `geography`;

-- Dumping structure for table geography.continents
...
-- Dumping data for table geography.continents: ~7 rows (approximately)
/*!40000 ALTER TABLE `continents` DISABLE KEYS */;
REPLACE INTO `continents` (`continent_code`, `continent_name`) VALUES
	('AF', 'Africa'),
	('AN', 'Antarctica'),
	('AS', 'Asia'),
	('EU', 'Europe'),
...
-- Dumping structure for table geography.countries
...
-- Dumping data for table geography.countries: ~250 rows (approximately)
/*!40000 ALTER TABLE `countries` DISABLE KEYS */;
REPLACE INTO `countries` (`country_code`, `iso_code`, `country_name`, `currency_code`, `continent_code`, `population`, `are_in_sq_km`, `capital`) VALUES
...
-- Dumping structure for table geography.countries_rivers
...
-- Dumping data for table geography.countries_rivers: ~104 rows (approximately)
/*!40000 ALTER TABLE `countries_rivers` DISABLE KEYS */;
REPLACE INTO `countries_rivers` (`river_id`, `country_code`) VALUES
	(1, 'BI'),
	(1, 'CD'),
	(1, 'EG'),
	(1, 'ER'),
...
-- Dumping structure for table geography.currencies
...
-- Dumping data for table geography.currencies: ~163 rows (approximately)
/*!40000 ALTER TABLE `currencies` DISABLE KEYS */;
REPLACE INTO `currencies` (`currency_code`, `description`) VALUES
...
-- Dumping structure for table geography.employees
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `first_name_middle_name_last_name_passportID` (`first_name`,`middle_name`,`last_name`,`passportID`),
  KEY `FK_employees_countries` (`country_code`),
  CONSTRAINT `FK_employees_countries` FOREIGN KEY (`country_code`) REFERENCES `countries` (`country_code`)
) ENGINE=InnoDB AUTO_INCREMENT=3462 DEFAULT CHARSET=utf8;

-- Dumping data for table geography.employees: ~13 rows (approximately)
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
REPLACE INTO `employees` (`id`, `first_name`, `middle_name`, `last_name`, `passportID`, `department`, `position`, `country_code`) VALUES
	(1, 'John', 'Avenger', 'Ausini', '643972016689', 'Marketing', 'Junior Marketing Specialist', NULL),
	(2, 'Pragubta', 'Brahaman', 'Kishivara', '43BG2432467545465', 'Programming', 'Senior Front-end developer', NULL),
	(3, 'Hoordvig', 'Van', 'Derholdt', 'H654364366546', 'Construction', 'Construction Worker', NULL),
	(6, 'Ivan', 'Stoyanov', 'Ivanov', '6439720166HT89', 'Marketing', 'Senior Marketer', NULL),
	(123, 'Ivan', 'Ivanov', 'Ivanov', NULL, 'Marketing', 'Junior Marketer', 'BG'),
	(678, 'Ivan', 'Stoyanov', 'Ivanov', NULL, 'Programming', 'Senior Front-end developer', NULL),
	(3446, 'Pragubta', 'Brahaman', 'Kishivara', '43IN2432467545465', 'Programming', 'Senior Front-end developer', 'IN'),
	(3447, 'John1', 'Avenger1', 'Ausini1', '643972016680', 'Marketing', 'Junior Marketing Specialist', 'AX'),
	(3448, 'John2', 'Avenger2', 'Ausini2', '643972016684', 'Marketing', 'Junior Marketing Specialist', 'BL'),
	(3449, 'John3', 'Avenger3', 'Ausini3', '643972016685', 'Marketing', 'Junior Marketing Specialist', 'AQ'),
	(3450, 'John4', 'Avenger4', 'Ausini4', '643972016686', 'Marketing', 'Junior Marketing Specialist', 'BR'),
	(3451, 'John5', 'Avenger5', 'Ausini5', '643972016687', 'Marketing', 'Junior Marketing Specialist', 'US'),
	(3460, 'Peter', 'Georgiev', 'Georgiev', '43IN243876846BGG', 'SysAdmin', 'Senior SysAdmin', 'US');
/*!40000 ALTER TABLE `employees` ENABLE KEYS */;

-- Dumping structure for table geography.employee_emails
CREATE TABLE IF NOT EXISTS `employee_emails` (
  `id` int(11) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `email_type` varchar(50) DEFAULT NULL,
  KEY `FK_employee_emails_employees` (`id`),
  CONSTRAINT `FK_employee_emails_employees` FOREIGN KEY (`id`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table geography.employee_emails: ~11 rows (approximately)
/*!40000 ALTER TABLE `employee_emails` DISABLE KEYS */;
REPLACE INTO `employee_emails` (`id`, `email`, `email_type`) VALUES
	(123, 'ivanov@abv.bg', 'personal'),
	(123, 'ivanov@bwct.com', 'work'),
	(123, 'summer_deals@bwct.com', 'work'),
	(3446, 'keepcalmwhenucode@abv.bg', 'personal'),
	(3446, 'pragubta@programming.bwct.com', 'work'),
	(3446, 'summer_vacations@programming.bwct.com', 'work'),
	(678, 'ivanov_is@abv.bg', 'personal'),
	(678, 'is_ivanov@bwct.com', 'work'),
	(3460, 'ivanov@abv.bg', 'personal'),
	(3460, 'peter@abv.bg', 'work'),
	(3460, 'peter.georgiev@abv.bg', 'work');
/*!40000 ALTER TABLE `employee_emails` ENABLE KEYS */;

-- Dumping structure for table geography.employee_phones
CREATE TABLE IF NOT EXISTS `employee_phones` (
  `id` int(11) DEFAULT NULL,
  `phone` varchar(50) DEFAULT NULL,
  `phone_type` varchar(50) DEFAULT NULL,
  KEY `FK_employee_phones_employees` (`id`),
  CONSTRAINT `FK_employee_phones_employees` FOREIGN KEY (`id`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table geography.employee_phones: ~9 rows (approximately)
/*!40000 ALTER TABLE `employee_phones` DISABLE KEYS */;
REPLACE INTO `employee_phones` (`id`, `phone`, `phone_type`) VALUES
	(123, '+7654656465655', 'personal'),
	(123, '+7654656656565', 'work'),
	(123, '+7654656656599', 'work'),
	(3446, '+5324552345345', 'personal'),
	(3446, '+3242342342344', 'work'),
	(3446, '+4123442344323', 'personal'),
	(3460, '+335040488881', 'personal'),
	(3460, '+7654656656565', 'work'),
	(3460, '+33598797988', 'work');
/*!40000 ALTER TABLE `employee_phones` ENABLE KEYS */;

-- Dumping structure for table geography.mountains
...
-- Dumping data for table geography.mountains: ~26 rows (approximately)
/*!40000 ALTER TABLE `mountains` DISABLE KEYS */;
REPLACE INTO `mountains` (`id`, `mountain_range`) VALUES
	(1, 'Alaska Range'),
	(2, 'Alborz'),
	(3, 'Andes'),
	(4, 'Balkan Mountains'),
...
-- Dumping structure for table geography.mountains_countries
...
-- Dumping data for table geography.mountains_countries: ~29 rows (approximately)
/*!40000 ALTER TABLE `mountains_countries` DISABLE KEYS */;
REPLACE INTO `mountains_countries` (`mountain_id`, `country_code`) VALUES
	(1, 'US'),
	(2, 'IR'),
	(3, 'AR'),
	(3, 'CL'),
...
-- Dumping structure for table geography.peaks
...
-- Dumping data for table geography.peaks: ~48 rows (approximately)
/*!40000 ALTER TABLE `peaks` DISABLE KEYS */;
REPLACE INTO `peaks` (`id`, `peak_name`, `elevation`, `mountain_id`) VALUES
	(62, 'Aconcagua', 6962, 3),
	(63, 'Botev', 2376, 4),
...
-- Dumping structure for table geography.rivers
...
-- Dumping data for table geography.rivers: ~30 rows (approximately)
/*!40000 ALTER TABLE `rivers` DISABLE KEYS */;
REPLACE INTO `rivers` (`id`, `river_name`, `length`, `drainage_area`, `average_discharge`, `outflow`) VALUES
