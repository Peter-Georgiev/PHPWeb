...
-- Dumping data for table soft_uni.addresses: ~291 rows (approximately)
...
-- Dumping data for table soft_uni.departments: ~16 rows (approximately)
/*!40000 ALTER TABLE `departments` DISABLE KEYS */;
REPLACE INTO `departments` (`department_id`, `name`, `manager_id`) VALUES
	(1, 'Engineering', 12),
	(2, 'Tool Design', 4),
	(3, 'Sales', 273),
	(4, 'Marketing', 46),
...
-- Dumping data for table soft_uni.employees: ~293 rows (approximately)
...
-- Dumping structure for table soft_uni.employees_projects
...
-- Dumping data for table soft_uni.employees_projects: ~845 rows (approximately)
...
-- Dumping structure for view soft_uni.get_addres_empl
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `get_addres_empl` (
	`employee_id` INT(10) NOT NULL,
	`first_name` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
	`middle_name` VARCHAR(50) NULL COLLATE 'utf8_general_ci',
	`last_name` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
	`address_text` VARCHAR(100) NOT NULL COLLATE 'utf8_general_ci',
	`name` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;

-- Dumping structure for view soft_uni.get_proj_empl
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `get_proj_empl` (
	`employee_id` INT(10) NOT NULL,
	`first_name` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
	`middle_name` VARCHAR(50) NULL COLLATE 'utf8_general_ci',
	`last_name` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
...
-- Dumping structure for table soft_uni.projects
...
-- Dumping data for table soft_uni.projects: ~81 rows (approximately)
...
REPLACE INTO `projects` (`project_id`, `name`, `description`, `start_date`, `end_date`) VALUES
	...
	(128, 'TEST', 'Test, test', '2017-11-01 15:20:04.000000', '2017-11-01 00:00:00.000000'),
	(129, 'TEST2', 'Test, test2', '2017-11-01 15:20:52.000000', '2017-11-01 00:00:00.000000');
...
-- Dumping data for table soft_uni.towns: ~32 rows (approximately)
/*!40000 ALTER TABLE `towns` DISABLE KEYS */;
REPLACE INTO `towns` (`town_id`, `name`) VALUES
	(1, 'Redmond'),
	(2, 'Calgary'),
	(3, 'Edmonds'),
	(4, 'Seattle'),
...
DROP TABLE IF EXISTS `get_addres_empl`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `get_addres_empl` AS SELECT e.employee_id AS employee_id, e.first_name, e.middle_name, e.last_name, a.address_text, t.name
FROM employees AS e
...
-- Dumping structure for view soft_uni.get_proj_empl
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `get_proj_empl`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `get_proj_empl` AS SELECT e.employee_id AS employee_id, e.first_name, e.middle_name, e.last_name, p.name, p.description, p.start_date, p.end_date
