...
-- Dumping structure for table geography.customer
CREATE TABLE IF NOT EXISTS `customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_name` varchar(50) NOT NULL,
  `customer_family` varchar(50) NOT NULL,
  `country_code` char(2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_customer_countries` (`country_code`),
  CONSTRAINT `FK_customer_countries` FOREIGN KEY (`country_code`) REFERENCES `countries` (`country_code`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Dumping data for table geography.customer: ~0 rows (approximately)
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
REPLACE INTO `customer` (`id`, `customer_name`, `customer_family`, `country_code`) VALUES
	(1, 'Taraba', 'Garabe', 'KI'),
	(2, 'Ivan', 'Ivanov', 'BG'),
	(3, 'Boyan', 'Stoyanov', 'BG'),
	(4, 'Stoyan', 'Ganchev', 'BG'),
	(5, 'Божидар', 'Божидаров', 'BG');
